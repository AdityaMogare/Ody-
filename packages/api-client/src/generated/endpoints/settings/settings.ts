...
export const getGetSettingsQueryOptions = <TData = Awaited<ReturnType<typeof getSettings>>, TError = ErrorType<Error>>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getSettings>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {
...
export type GetSettingsQueryError = ErrorType<Error>


export function useGetSettings<TData = Awaited<ReturnType<typeof getSettings>>, TError = ErrorType<Error>>(
...
export const patchSettings = async (updateSettingsBody: UpdateSettingsBody, options?: RequestInit): Promise<patchSettingsResponse> => {
...
export const getPatchSettingsMutationOptions = <TError = ErrorType<Error>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof patchSettings>>, TError,{data: UpdateSettingsBody}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof patchSettings>>, TError,{data: UpdateSettingsBody}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof patchSettings>>, {data: UpdateSettingsBody}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PatchSettingsMutationBody = UpdateSettingsBody
    export type PatchSettingsMutationError = ErrorType<Error>

    export const usePatchSettings = <TError = ErrorType<Error>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof patchSettings>>, TError,{data: UpdateSettingsBody}, TContext>, request?: SecondParameter<typeof customFetch>}
